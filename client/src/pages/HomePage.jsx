    ...
    return (
        <div className='h-screen bg-indigo-600'>
            <div className='flex flex-col justify-center items-center text-center p-4'>
                ...
                『Shall We Talk』と共に、ビジネスの可能性を広げませんか？
                </div>
                <div className='text-xs sm:text-xl text-white w-3/4 sm:w-2/4 mt-4 font-Poppins'>
                SWTは、知らない方との会話を始めるあなたの最初の１歩を後押しするアプリケーションです。
                </div>
                ...
                { !loadeduser.login ? <a href='/login-register' className='sm:w-2/5 text-sm sm:text-md mt-8 text-indigo-600 bg-white rounded py-2 px-2 cursor-pointer hover:bg-gray-100'>ご使用いただくためには、ログイン、または新規アカウント登録が必要になります。</a> : null }
            </div>
        </div>
    )
}
